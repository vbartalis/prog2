...
#include <fstream>
#include<vector>		// fájlból olvasunk, írunk majd
...
public:
     ...
     {
	   std::cout << "LZWBinFa copy értékadás" << std::endl;
     ...
     {
       std::cout << "LZWBinFa move értékadás" << std::endl;
...
// akkor ezek látszanak majd a gyerek osztályban is
	...
	friend std::ostream& operator<< (std::ostream& os, std::vector<LZWBinFa> obj_vec)
	  {
